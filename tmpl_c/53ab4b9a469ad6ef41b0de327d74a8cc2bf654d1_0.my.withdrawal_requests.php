...
?> <tr class="<?php echo smarty_function_cycle(array('values'=>"row1,row2"),$_smarty_tpl);?>
 trn_user"> <td> <?php if ($_smarty_tpl->tpl_vars['t']->value['auto_started']) {?> <div class="hlp" title="Transaction has been aborted. Check on payment processing and take action manually."><span class="badge badge-danger">!!!</span> <?php } else { ?> <input type=checkbox name="trn[<?php echo $_smarty_tpl->tpl_vars['t']->value['id'];?>
]" class="trn" id="trn_<?php echo $_smarty_tpl->tpl_vars['t']->value['id'];?>
" value=1<?php if ($_smarty_tpl->tpl_vars['t']->value['mult']) {?> data-mult=1<?php }?> <?php if ($_smarty_tpl->tpl_vars['t']->value['auto_withdraw'] == 0) {?>data-non-auto=1<?php }?>> <?php }?> </td> <td> <?php if ($_smarty_tpl->tpl_vars['t']->value['mult']) {?><span class="badge-bg badge-danger">Mult</span><?php }?> <?php if ($_smarty_tpl->tpl_vars['t']->value['account_deleted']) {?><s>user deleted</s><?php } else { ?><a class="link username"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['t']->value['username'], ENT_QUOTES, 'UTF-8', true);?>
</a> <small>(Upline: <?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['t']->value['ref_username'])===null||$tmp==='' ? "n/a" : $tmp), ENT_QUOTES, 'UTF-8', true);?>
)</small><?php }?></b> <a class="badge badge-danger" target="_blank" href="?a=user_edit&id=<?php echo $_smarty_tpl->tpl_vars['t']->value['user_id'];?>
">edit</a> <a class="badge badge-info" target="_blank" href="?a=user_details&id=<?php echo $_smarty_tpl->tpl_vars['t']->value['user_id'];?>
">manage</a> <?php if ($_smarty_tpl->tpl_vars['t']->value['auto_withdraw'] == 0) {?><span class="badge-bg badge-danger">No Auto Withdraw</span><?php }?> <?php if ($_smarty_tpl->tpl_vars['t']->value['account_array']) {?> <?php
...
</small> <br><small style="color:#2F4F4F">Balance: <?php echo amount_smarty_fiat($_smarty_tpl->tpl_vars['t']->value['user_balances']['balance']);?>
 | Active Deposit: <?php echo amount_smarty_fiat($_smarty_tpl->tpl_vars['t']->value['user_balances']['active_deposit']);?>
...
</small><?php }?> </td> <td nowrap align=center> <a href="?a=withdrawal_requests&action2=pay_manual&id=<?php echo $_smarty_tpl->tpl_vars['t']->value['id'];?>
