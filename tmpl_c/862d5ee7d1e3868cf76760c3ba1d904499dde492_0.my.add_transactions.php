<?php /* Smarty version 3.1.27, created on 2022-08-14 11:58:07
         compiled from "my:add_transactions" */ ?>
<?php
/*%%SmartyHeaderCode:125590098562f8c72f3a9927_02508313%%*/
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '125590098562f8c72f3a9927_02508313',
  'variables' => 
  array (
    'fatals' => 0,
    'frm' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_62f8c72f3e22a7_46154102',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_62f8c72f3e22a7_46154102')) {
function content_62f8c72f3e22a7_46154102 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '125590098562f8c72f3a9927_02508313';
?>
...
)</td> </tr> <?php } else { ?> <tr> <th>Send to:</th> <td> <select name=to id="to_inpt" class=inpts onchange="toggle_users()"> <option value="users" <?php if ($_smarty_tpl->tpl_vars['frm']->value['to'] == "users") {?>selected<?php }?>>Specified users (enter a usernames below)</option> <option value="all" <?php if ($_smarty_tpl->tpl_vars['frm']->value['to'] == "all") {?>selected<?php }?>>All users</option> <option value="active" <?php if ($_smarty_tpl->tpl_vars['frm']->value['to'] == "active") {?>selected<?php }?>>All users which have made a deposit</option> <option value="passive" <?php if ($_smarty_tpl->tpl_vars['frm']->value['to'] == "passive") {?>selected<?php }?>>All users which have not made a deposit</option> <?php
...
?>  </select> </td> </tr> <tr id="usernames_row" style="display:none"> <th>Enter Usernames:</th> <td><textarea name=usernames class=inpts rows=10><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['frm']->value['usernames'], ENT_QUOTES, 'UTF-8', true);?>
