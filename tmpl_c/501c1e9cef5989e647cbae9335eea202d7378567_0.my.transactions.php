...
</b> <a class="badge badge-danger" target="_blank" href="?a=user_edit&id=<?php echo $_smarty_tpl->tpl_vars['t']->value['user_id'];?>
...
:</b> &nbsp; <?php echo smarty_modifier_replace(htmlspecialchars($_smarty_tpl->tpl_vars['t']->value['description'], ENT_QUOTES, 'UTF-8', true),"&amp;","&");?>
...
.gif" align=absmiddle hspace=1 height=17></td> <?php if ($_smarty_tpl->tpl_vars['setts']->value['use_admin_history_balance_mode']) {?> <td align=right><?php echo amount_smarty_fiat($_smarty_tpl->tpl_vars['t']->value['balance'],$_smarty_tpl->tpl_vars['t']->value['ec']);?>
</td> <?php }?> <td align=center><small><?php echo $_smarty_tpl->tpl_vars['t']->value['d'];?>
</small></td> </tr>  <?php
