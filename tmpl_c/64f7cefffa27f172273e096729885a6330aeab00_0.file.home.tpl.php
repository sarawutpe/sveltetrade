<?php /* Smarty version 3.1.27, created on 2023-01-15 09:50:18
         compiled from "C:\xampp\htdocs\tmpl\home.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:123151413963c3be4a9748f2_93396262%%*/
if (!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array(
  'file_dependency' =>
  array(
    '64f7cefffa27f172273e096729885a6330aeab00' =>
    array(
      0 => 'C:\\xampp\\htdocs\\tmpl\\home.tpl',
      1 => 1673768091,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '123151413963c3be4a9748f2_93396262',
  'variables' =>
  array(
    'settings' => 0,
    'userinfo' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_63c3be4a9a0c66_90138638',
), false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_63c3be4a9a0c66_90138638')) {
  function content_63c3be4a9a0c66_90138638($_smarty_tpl)
  {
    if (!is_callable('smarty_modifier_myescape')) require_once 'C:\\xampp\\htdocs\\inc\\libs\\smarty3\\plugins\\modifier.myescape.php';

    $_smarty_tpl->properties['nocache_hash'] = '123151413963c3be4a9748f2_93396262';
?>
    <!DOCTYPE html>
    <html lang="en">
...
">
              <img src="./assets/img/logo.png" width="82px" height="32px" alt="logo" class="logo" />
            </a>
            <div class="menu">
...
">Sigun up free</a>
      ...
      for(float t=0.0;t<=50.0;t++){ float percent=(t+offset)/40.0; float weight=100.0*(percent-percent*percent); vec4 sample=texture2D(tDiffuse,vUv+toCenter*percent*strength/resolution); sample.rgb*=sample.a; color+=sample*weight; total+=weight; } gl_FragColor=color/total; gl_FragColor.rgb /=gl_FragColor.a; //gl_FragDepth=color; } <?php echo '</script'; ?>>
        <?php echo '<script'; ?>
