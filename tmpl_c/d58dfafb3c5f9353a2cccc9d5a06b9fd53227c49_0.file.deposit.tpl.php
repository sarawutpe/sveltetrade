<?php /* Smarty version 3.1.27, created on 2023-02-01 09:38:33
         compiled from "C:\xampp\htdocs\sveltetrade\tmpl\deposit.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:980045463da25096da605_30245875%%*/
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '980045463da25096da605_30245875',
  'variables' => 
  array (
    'fatal' => 0,
    'frm' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_63da2509725a28_79044924',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_63da2509725a28_79044924')) {
function content_63da2509725a28_79044924 ($_smarty_tpl) {
...
$_smarty_tpl->properties['nocache_hash'] = '980045463da25096da605_30245875';
?>
...
&quot; should not more than
                  <?php echo smarty_modifier_myescape(amount_smarty_fiat($_smarty_tpl->tpl_vars['errors']->value['deposits_amount_exeeded']['amount_limit']));?>
            ...
            <form method=post name="spendform">
              <div class="grid-container grid-column-2">
                ...
                <div class="form-control">
                  ...
                  <?php if ($_smarty_tpl->tpl_vars['qplans']->value > 1) {?><span class="fontSize-mPlus fontWeight-regular mb-2">Select a plan</span><?php }?>
                  <div class="field">
                    <div>
                      <?php
...
" type="radio" class="card-plan"
                              name="h_id" value="<?php echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['plan']->value['id']);?>
"
                              <?php if ((((isset($_smarty_tpl->tpl_vars['__foreach_fplans']->value['first']) ? $_smarty_tpl->tpl_vars['__foreach_fplans']->value['first'] : null) == 1) && (!$_smarty_tpl->tpl_vars['frm']->value['h_id'])) || ($_smarty_tpl->tpl_vars['frm']->value['h_id'] == $_smarty_tpl->tpl_vars['plan']->value['id'])) {?> checked
                              <?php }?>>
                            <?php
...
">
                                <fluent-card class="card card-plan-item">
                                  <span id="plan-name"
                                    class="fontSize-mPlus fontWeight-semibold mb-2"><?php echo smarty_modifier_myescape(htmlspecialchars($_smarty_tpl->tpl_vars['o']->value['name'], ENT_QUOTES, 'UTF-8', true));?>
</span>
...
" <?php if ($_smarty_tpl->tpl_vars['frm']->value['type'] == "process_".((string)$_smarty_tpl->tpl_vars['p']->value['id'])) {?>selected<?php }?>>Topup
...
" <?php if ($_smarty_tpl->tpl_vars['frm']->value['type'] == "account_".((string)$_smarty_tpl->tpl_vars['p']->value['id'])) {?>selected<?php }?>
                          <?php if ($_smarty_tpl->tpl_vars['p']->value['available'] <= 0) {?>disabled<?php }?>>Balance <?php echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['p']->value['name']);?>
...
?>
                  ...
                  <div class="flex justify-content-between">
                    ...
                    <fluent-badge id="select-min-amount" class="cursor-pointer" appearance="accent">SELECT MIN SPEND
                    </fluent-badge>
                  </div>
