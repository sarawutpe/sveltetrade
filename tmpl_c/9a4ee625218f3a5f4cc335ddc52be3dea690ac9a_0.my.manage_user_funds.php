<?php /* Smarty version 3.1.27, created on 2023-01-28 08:44:18
         compiled from "my:manage_user_funds" */ ?>
<?php
/*%%SmartyHeaderCode:127840973063d4d2525969d9_07413582%%*/
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '127840973063d4d2525969d9_07413582',
  'variables' => 
  array (
    'user' => 0,
    'ps' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_63d4d2525d39e9_85610301',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_63d4d2525d39e9_85610301')) {
function content_63d4d2525d39e9_85610301 ($_smarty_tpl) {
if (!is_callable('smarty_function_cycle')) require_once 'C:\\xampp\\htdocs\\sveltetrade\\inc\\libs\\smarty3\\plugins\\function.cycle.php';

$_smarty_tpl->properties['nocache_hash'] = '127840973063d4d2525969d9_07413582';
?>
...
?>
  <style> .sbmt-group { display: inline-block; float: right; } </style>  <h3>User Details: <a href="?a=user_edit&id=<?php echo $_smarty_tpl->tpl_vars['user']->value['id'];?>
" class="sbmt btn-sm btn-success">edit</a></h3> <table class=form> <tr> <th>Username:</th> <td><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user']->value['username'], ENT_QUOTES, 'UTF-8', true);?>
...
&ttype=deposit" class="sbmt btn-sm btn-info" style="float:right">history</a></div></td> </tr> <tr> <th>Active Deposit:</th> <td><?php echo amount_smarty_fiat(amount_smarty_format(abs($_smarty_tpl->tpl_vars['user']->value['amounts']['active_deposit'])));?>
 <div class="sbmt-group"> <a href="?a=user_deposits&id=<?php echo $_smarty_tpl->tpl_vars['user']->value['id'];?>
...
&ttype=earning" class="sbmt btn-sm btn-info">history</a></div></td> </tr>  <tr> <th>Total Withdrawal:</th> <td><?php echo amount_smarty_fiat(amount_smarty_format(abs($_smarty_tpl->tpl_vars['user']->value['amounts']['withdrawal'])));?>
 <div class="sbmt-group"><a href="?a=user_withdraw_request&userid=<?php echo $_smarty_tpl->tpl_vars['user']->value['id'];?>
" class="sbmt btn-sm btn-danger">Withdraw Request</a> <a href="?a=transactions&userid=<?php echo $_smarty_tpl->tpl_vars['user']->value['id'];?>
&ttype=withdrawal" class="sbmt btn-sm btn-info">history</a></div></td> </tr> <tr> <th>Pending Withdrawals:</th> <td><?php echo amount_smarty_fiat(amount_smarty_format(abs($_smarty_tpl->tpl_vars['user']->value['amounts']['withdraw_pending'])));?>
