...
{if $frm.display == "ok"}<div class="alert success">Exchange has been successfully completed.</div>{/if}

{if $errors.no_from}<div class="alert error">No source currency is specified.</div>{/if}
{if $errors.no_to}<div class="alert error">No destination currency is specified.</div>{/if}
{if $errors.no_amount}<div class="alert error">No exchange amount is specified.</div>{/if}
{if $errors.not_enough_funds}<div class="alert error">You have not enough funds to exchange from.</div>{/if}
{if $errors.exchange_forbidden}<div class="alert error">The exchange for specified currencies is not allowed.</div>{/if}
{if $errors.too_small_amount}<div class="alert error">The amount you have entered for exchange is too small.</div>{/if}
