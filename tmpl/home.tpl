  ...
  <div class="container">
    <div class="main">
      ...
      <div class="classic-bg">
        ...
        <div class="classic-inner">
          <div class="about">
            <span class="text-lg mb-2">About Svelete Trade</span>
            <span style="max-width: 500px;" class="text-sm mb-4">
              sveletetrade.com is a virtual stock exchange trading provider.
              With the cutting-edge system that enables the trading orders to be
              executed with 99.9% uptime, bringing more opportunity and profit to investors.
            </span>
          </div>
        </div>
      </div>
      ...
      <section class="glass-content">
        <div class="glass-wrapper">
          ...
          <div class="glass-item">
            ...
            <span class="title">Make quick profits</span>
            <span class="desc">
              With our realistic virtual trading tools, asset management is a breeze
            </span>
          </div>
          <div class="glass-item">
            <div class="image">
            ...
            <span class="title">Multiple currencies</span>
            <span class="desc">
              We accept payments from all channels. Easy and convenient
            </span>
          </div>
          <div class="glass-item">
            <div class="image">
            ...
            <span class="desc">
              Our software runs on a global quality platform. Start trading and make profits today
            </span>
          </div>
        </div>
      </section>
    ...
    <section class="footer">
      <div class="infos">
        <img class="logo" src="./assets/img/logo.png" width="180px" height="22px" alt="logo" />
        <span class="info">support@sveletetrade.com</span>
        <span class="info">Copyright © 2022 Ivypay.org All rights reserved.</span>
      </div>
      <div class="menu">
        <a href="{"?a=news"|encurl}">News</a>
        {if $userinfo.logged === 1}
          <a href="{"?a=account"|encurl}">Dashboard</a>
        {else}
          <a href="{"?a=login"|encurl}">Sign in</a>
